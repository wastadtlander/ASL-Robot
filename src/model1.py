...
model = Sequential()
model.add(Conv2D(8, (5, 5), strides=1, padding="same", activation="relu", input_shape=(28, 28, 1)))
...
history = model.fit(datagen.flow(trainAttributes, trainLabels, batch_size=128), epochs=25, validation_data=(testAttributes, testLabels))
